...
CONFIG_CONST( P_PUB_WINDOW_COUNT     , "pub_window_count" )
CONFIG_CONST( P_PUB_WINDOW_AUTOSCALE , "pub_window_autoscale" )
CONFIG_CONST( P_SUB_WINDOW_COUNT     , "sub_window_count" )
...
CONFIG_CONST( P_TCP_CONNECT_TIMEOUT  , "tcp_connect_timeout" )
...
CONFIG_CONST( P_TCP_KEEPALIVE        , "tcp_keepalive" )
...
CONFIG_CONST( P_MAX_WRITE_BUFFER     , "max_write_buffer" )
CONFIG_CONST( P_BLOCKED_STALL_WINDOW , "blocked_stall_window" )
